	...
	case 'hidetag':
       ...
       /*case 'ownergrup':
		...
		if (budy.includes(`buenos dias`)) {
                  reply(`Buenos dias banda ¿Cómo estan?`)
                  }

		if (budy.includes(`bot gay`)) {
                  reply(`¿Acaso buscas pareja?`)
                  }

		if (budy.includes(`Gracias`)) {
                  reply(`Son 5 pesos, no hay de que`)
                  }
